...
<html>
	<head>
		...
		<meta name="keywords" content="motoryzacja, samochody, osobowe"/>
	</head>
					...
					if($w['ID'] != ''){
						...
						// Drugi oddzielnik (1 pod zdjęciem), zgłoś, odśwież, wyróżnij:
							...
							echo '<div style="height: 45px; font-size: 25px; color: #CCC; text-shadow: 1px 1px black;">
								...
								echo '<div class="oglci"><b>Kategoria:</b></div> <div class="oglci1">Motoryzacja ● Samochody osobowe</div><br>';
								echo '<div class="oglci"><b>Marka:</b></div> <div class="oglci1">'.$w['Marka'].'</div><br>';
								echo '<div class="oglci"><b>Model:</b></div> <div class="oglci1">'.$w['Model'].'</div><br>';
								...
								echo '<div class="oglci"><b>Nadwozie:</b></div> <div class="oglci1">'.$w['Nadwozie'].'</div><br>';
								echo '</div>';
								//Prawa strona
