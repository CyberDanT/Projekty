					...
					if($w['ID'] != ''){
						...
						// Drugi oddzielnik (1 pod zdjęciem), zgłoś, odśwież, wyróżnij:
							...
							echo '<div style="height: 45px; font-size: 25px; color: #CCC; text-shadow: 1px 1px black;">
								...
								echo '<div class="oglci"><b>Kategoria:</b></div> <div class="oglci1">Motoryzacja ● Motocykle i skutery</div><br>';
								echo '<div class="oglci"><b>Typ:</b></div> <div class="oglci1">'.$w['Typ'].'</div><br>';
