...
$_SESSION['info_ogl2'] = 'elektronika_akcesoria';
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<meta name="keywords" content="elektronika, akcesoria, ledy, zarowki"/>
	</head>
...
<?php
	...
	$zapytanie = 'SELECT * FROM elektronika_akcesoria WHERE ID="'.$ID.'"';
							...
							echo '<div style="height: 45px; font-size: 25px; color: #CCC; text-shadow: 1px 1px black;">
										...
										<div class="zna">
											<form method="post" target = "_blank" action="../zglosnaduzycie.php">
												<input type="hidden" name="category" value="elektronika_akcesoria">
