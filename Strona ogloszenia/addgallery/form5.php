...
<html>
	...
	<body style="background-color: white; overflow: hidden;">
		<form enctype="multipart/form-data" action="photos.php" method="post">
			...
			<label><div class="forminp"><div class="file1">+</div><input onChange="document.getElementById('submit').click()" class="file2" type="file" name="Photo5" accept="image/png, image/jpeg, image/jpg"></div></label>
