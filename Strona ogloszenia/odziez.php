...
<html lang="pl">
  <head>
	<title>Wszystko w odzież - BezGrosika.pl serwis ogłoszeniowy</title>
	<link rel="shortcut icon" href="img/grosiky.png">
	<meta name="keywords" content="serwis ogłoszeniowy, ubrania weselne i suknie ślubne, buty, dodatki, zegarki i akcesoria bezgrosika"/>
	<meta name="description" content="Wszystko w kategorii odzież. Suknie ślubne, sukienki, garnitury, buty, dodatki - zegarki - akcesoria, i inne w ogłoszeniach BezGrosika.pl"/>
	<meta charset="utf-8">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Odzież</h1>
                <p class="mb-0">Wszystkie ogłoszenia w odzieży</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Wszystkie w odzieży</h2>
          </div>
        </div>
        <div class="row mt-5">
					...
					try{					
						...
						if(!$connect->set_charset("utf8")){
							...
							if($result = $connect->query($pytanietymczasowa)){
								...
								$pytanko1 = 'SELECT * FROM odziez_buty';
								...
								$connect->select_db($administratorbazy.'odziez');
								$pytanko1 = 'SELECT * FROM odziez_dodatki';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'odziez');
								$pytanko1 = 'SELECT * FROM odziez_pozostale';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'odziez');
								$pytanko1 = 'SELECT * FROM odziez_ubrania';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'odziez');
								$pytanko1 = 'SELECT * FROM odziez_zegarki';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								if($result = @$connect->query($pytanie)){
									...
									<div class="col-12 mt-5 text-center">
									  <div class="custom-pagination">';
										if($lStron != 0){
											if($showpage != 1){
												echo '<a href="odziez.php?page='.$previouspage.'">'.$seepreviouspage.'</a>';
											}else{
												echo '<a href="#">_</a>';
											}
											...
											if($lStron == $showpage){
												...
												echo '<a href="odziez.php?page='.$nextpage.'">'.$seepage.'</a>';
											}
