...
<?php
	$_SESSION['info_ogl'] = 'nieruchomosci';
	$_SESSION['info_ogl2'] = 'nieruchomosci_mieszkania';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."nieruchomosci";
	$zapytanie = 'SELECT * FROM nieruchomosci_mieszkania WHERE ID="'.$ID.'"';
								...
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="nieruchomosci_mieszkania">
									...
									if($w['Kategoria'] == 'Wynajme'){
										$sprzedamwynajme = 'Wynajmę';
									}else{
										$sprzedamwynajme = $w['Kategoria'];
									}
									//Katerogia marka itd lewa strona
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Nieruchomości <span style="font-size: 10px;">●</span> Mieszkania <span style="font-size: 10px;">●</span> '.$sprzedamwynajme.'</div><br>';
									echo '</div>';
