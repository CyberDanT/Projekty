...
<?php
	...
	$_SESSION['info_ogl2'] = 'nieruchomosci_dzialki';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."nieruchomosci";
	$zapytanie = 'SELECT * FROM nieruchomosci_dzialki WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="nieruchomosci_dzialki">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Nieruchomości <span style="font-size: 10px;">●</span> Działki <span style="font-size: 10px;">●</span> '.$sprzedamwynajme.'</div><br>';
									echo '</div>';
