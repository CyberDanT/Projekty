...
<?php
	...
	$_SESSION['info_ogl2'] = 'elektronika_tablety';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."elektronika";
	$zapytanie = 'SELECT * FROM elektronika_tablety WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="elektronika_tablety">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Elektronika <span style="font-size: 10px;">●</span> Tablety</div><br>';
									echo '</div>';
