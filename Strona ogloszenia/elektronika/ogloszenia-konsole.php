...
<?php
	...
	$_SESSION['info_ogl2'] = 'elektronika_konsole';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."elektronika";
	$zapytanie = 'SELECT * FROM elektronika_konsole WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="elektronika_konsole">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Elektronika <span style="font-size: 10px;">●</span> Konsole</div><br>';
									echo '</div>';
