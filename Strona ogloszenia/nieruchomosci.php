...
<html lang="pl">
  <head>
	...
	<title>Wszystko w nieruchomości - BezGrosika.pl serwis ogłoszeniowy</title>
	<meta name="keywords" content="serwis ogłoszeniowy, nieruchomości kupię sprzedam dom, mieszkanie, działki, kupię lub sprzedam garaż, bezgrosika"/>
	<meta name="description" content="Wszystko w kategorii nieruchomości. Kupię, sprzedam lub wynajmę mieszkanie, dom. Wynajmę lub sprzedam garaż, działkę i inne w ogłoszeniach BezGrosika.pl"/>
	<meta charset="utf-8">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Nieruchomości</h1>
                <p class="mb-0">Wszystkie ogłoszenia w nieruchomościach</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Wszystkie w nieruchomościach</h2>
          </div>
        </div>
        <div class="row mt-5">
					...
					try{					
						...
						if(!$connect->set_charset("utf8")){
							...
							if($result = $connect->query($pytanietymczasowa)){
								...
								$pytanko1 = 'SELECT * FROM nieruchomosci_domy';
								...
								$connect->select_db($administratorbazy.'nieruchomosci');
								$pytanko1 = 'SELECT * FROM nieruchomosci_dzialki';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'nieruchomosci');
								$pytanko1 = 'SELECT * FROM nieruchomosci_garaze';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'nieruchomosci');
								$pytanko1 = 'SELECT * FROM nieruchomosci_mieszkania';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'nieruchomosci');
								$pytanko1 = 'SELECT * FROM nieruchomosci_pozostale';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								if($result = @$connect->query($pytanie)){
									...
									<div class="col-12 mt-5 text-center">
									  <div class="custom-pagination">';
										if($lStron != 0){
											if($showpage != 1){
												echo '<a href="nieruchomosci.php?page='.$previouspage.'">'.$seepreviouspage.'</a>';
											}else{
												echo '<a href="#">_</a>';
											}
											...
											if($lStron == $showpage){
												...
												echo '<a href="nieruchomosci.php?page='.$nextpage.'">'.$seepage.'</a>';
											}
