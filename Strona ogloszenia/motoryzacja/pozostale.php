...
<html lang="pl">
  <head>
	<title>Ogłoszenia BezGrosika.PL - motoryzacja, pozostałe</title>
	<meta name="description" content="Motoryzacja - pozostałe. Części samochodowe i motocyklowe, lampy, reflektory, żarówki, ledy..."/>
	<meta name="keywords" content="ogłoszenia, BezGrosika, .pl, sprzedam, kupie, pozostale, zarowki, ledy, audi, volkswagen, bmw, klosze lamp, bez grosika"/>
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Pozostałe</h1>
                <p class="mb-0">Wszystkie ogłoszenia pozostałe w motoryzacji</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Wszystkie w pozostałe</h2>
          </div>
        </div>
        <div class="row mt-5">
		...
		<?php
							$zapytanie = 'SELECT * FROM pozostale WHERE datepromotion > NOW()';
							$zapytanie1 = 'SELECT * FROM pozostale WHERE datepromotion < NOW()';
							...
							try {
								...
								if(!$connect->set_charset("utf8")){
									...
									if($result = $connect->query('SELECT * FROM pozostale')){
										...
										if($wyniki>0){
											for($r = 1; $r <= $wyniki; $r++){
												...
												if($w['dateremove'] <= $date){
													...
													@$connect->query('DELETE FROM pozostale WHERE ID='.$w['ID'].'');
												}
											}
										}
										$result->free_result();
