...
<html lang="pl">
<head>
	<title>Ogłoszenia BezGrosika.pl - motocykle i skutery</title>
	<meta name="keywords" content="motoryzacja, motocykl, skuter, quad"/>
  ...
  <div class="site-wrap">
	...
	$_SESSION['info_ogl2'] = 'motocykle i skutery';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."motoryzacja";
	$zapytanie = 'SELECT * FROM motocykle_skutery WHERE ID="'.$ID.'"';
								  ...
								  <div class="col-lg-8">
									...
									<div class="mb-4">
									  <div class="slide-one-item home-slider owl-carousel">';
										$num = 3; // Maksymalna ilość zdjęć w danej kategorii
										$stop = false;
										$number = 1;
										for($p = 1; $p<=$num; $p++){
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="motocykle_skutery">
									...
									echo '<div><b>Typ</b></div> <div>'.$w['Typ'].'</div><br>';
