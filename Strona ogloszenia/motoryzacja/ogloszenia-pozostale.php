...
<head>
	...
	<meta name="keywords" content="motoryzacja, samochody, ledy, żarówki"/>
...
<?php
	...
	$zapytanie = 'SELECT * FROM pozostale WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Motoryzacja <span style="font-size: 10px;">●</span> Pozostałe</div><br>';
									echo '</div>';
