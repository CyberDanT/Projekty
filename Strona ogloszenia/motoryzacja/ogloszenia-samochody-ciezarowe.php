...
<head>
	...
	<meta name="keywords" content="motoryzacja, samochody, ciezarowe"/>
  ...
  <div class="site-wrap">
	...
	$_SESSION['info_ogl2'] = 'samochody ciezarowe';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."motoryzacja";
	$zapytanie = 'SELECT * FROM samochody_ciezarowe WHERE ID="'.$ID.'"';
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="samochody_ciezarowe">
