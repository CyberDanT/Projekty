...
<head>
	...
	<meta name="keywords" content="motoryzacja, caraudio, radio"/>
...
<?php
	...
	$_SESSION['info_ogl2'] = 'sprzet audio';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."motoryzacja";
	$zapytanie = 'SELECT * FROM audio WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Motoryzacja <span style="font-size: 10px;">●</span> Sprzęt audio</div><br>';
									echo '</div>';
