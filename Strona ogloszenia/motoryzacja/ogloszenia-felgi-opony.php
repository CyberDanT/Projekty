...
<html lang="pl">
<head>
	<title>Ogłoszenia BezGrosika.pl - felgi i opony</title>
	<meta name="keywords" content="motoryzacja, samochody, osobowe, felgi, opony"/>
...
<?php
	...
	$_SESSION['info_ogl2'] = 'felgi i opony';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."motoryzacja";
	$zapytanie = 'SELECT * FROM felgi_opony WHERE ID="'.$ID.'"';
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="felgi_opony">
