...
<html lang="pl">
  <head>
	<title>Dla domu i ogrodu, pozostałe - Ogłoszenia BezGrosika.pl</title>
	<meta name="description" content="Dom i ogród, meble, oświetlenie, ogród, dla domu, RTV i AGD."/>
	<meta name="keywords" content="ogłoszenia, BezGrosika, .pl, sprzedam, kupie, pozostałe, dla domu"/>
  ...
  <div class="site-wrap">
	...
	<div class="site-section bg-light">
      <div class="container">
		  ...
		  <div class="col-lg-6">
            <div class="d-block d-md-flex listing">
              ...
              <div class="lh-content">
                ...
                <h3><a href="#">Materiały budowlane</a></h3>
                <address style="display: inline-block;"><span style="display: inline-block;" class="icon-tags"></span> 250 PLN</address>
              </div>
            </div>
		  </div>
		...
		<?php
							$zapytanie = 'SELECT * FROM domogrod_pozostale WHERE datepromotion > NOW()';
							$zapytanie1 = 'SELECT * FROM domogrod_pozostale WHERE datepromotion < NOW()';
							...
							try {
								...
								if(!$connect->set_charset("utf8")){
									...
									if($result = $connect->query('SELECT * FROM domogrod_pozostale')){
										...
										if($wyniki>0){
											for($r = 1; $r <= $wyniki; $r++){
												...
												if($w['dateremove'] <= $date){
													...
													@$connect->query('DELETE FROM domogrod_pozostale WHERE ID='.$w['ID'].'');
												}
											}
										}
										$result->free_result();
		...
		// --------------------------------------------- WYŚWIETLENIE WYNIKÓW ------------------------------------------------------------------
						...
						try{
							...
							if (!$connect->set_charset("utf8")) {
								...
								$pytanie = 'SELECT * FROM domogrod_pozostale';
