...
<?php
	...
	$_SESSION['info_ogl2'] = 'ogrod';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."domiogrod";
	$zapytanie = 'SELECT * FROM domogrod_ogrod WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="domogrod_ogrod">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Dom i ogród <span style="font-size: 10px;">●</span> Ogród</div><br>';
									echo '</div>';
