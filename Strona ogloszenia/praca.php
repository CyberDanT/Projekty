...
<html lang="pl">
  <head>
	<title>Wszystko w praca - BezGrosika.pl serwis ogłoszeniowy</title>
	<link rel="shortcut icon" href="img/grosiky.png">
	<meta name="keywords" content="serwis ogłoszeniowy, kierowca, murarz, tynkarz, hydraulik, praca na stałe, praca dorywcza w kraju lub za granicą, usługi kierowców, murarzy i inne, bezgrosika"/>
	<meta name="description" content="Wszystko w kategorii praca. Praca na stałe, praca dorywcza w kraju lub za granicą, usługi kierowców, murarzy i inne w ogłoszeniach BezGrosika.pl"/>
	<meta charset="utf-8">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Praca</h1>
                <p class="mb-0">Wszystkie ogłoszenia w pracy</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Wszystkie w pracy</h2>
          </div>
        </div>
        <div class="row mt-5">
		  ...
		  <div class="col-lg-6">
            <div class="d-block d-md-flex listing">
              ...
              <div class="lh-content">
                ...
                <h3><a href="#">Dam pracę!</a></h3>
                <address style="display: inline-block;"><span style="display: inline-block;" class="icon-tags"></span> 3 500 PLN</address>
              </div>
            </div>
		  </div>
					...
					try{					
						...
						if(!$connect->set_charset("utf8")){
							...
							if($result = $connect->query($pytanietymczasowa)){
								...
								$pytanko1 = 'SELECT * FROM praca_dorywcza';
								...
								$connect->select_db($administratorbazy.'praca');
								$pytanko1 = 'SELECT * FROM praca_pozostale';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'praca');
								$pytanko1 = 'SELECT * FROM praca_uslugi';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'praca');
								$pytanko1 = 'SELECT * FROM praca_wkraju';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'praca');
								$pytanko1 = 'SELECT * FROM praca_zagranica';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								if($result = @$connect->query($pytanie)){
									...
									<div class="col-12 mt-5 text-center">
									  <div class="custom-pagination">';
										if($lStron != 0){
											if($showpage != 1){
												echo '<a href="praca.php?page='.$previouspage.'">'.$seepreviouspage.'</a>';
											}else{
												echo '<a href="#">_</a>';
											}
											...
											if($lStron == $showpage){
												...
												echo '<a href="praca.php?page='.$nextpage.'">'.$seepage.'</a>';
											}
