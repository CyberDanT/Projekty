...
<html lang="pl">
  <head>
    <title>Reklama u nas - BezGrosika.pl</title>
    <meta name="keywords" content="ogłoszenia, bez grosika, ogłoszenia darmowe, reklama bez grosika,"/>
    <meta name="description" content="Zainteresowany współpracą? Zareklamuj się u nas!"/>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="active"><a href="reklama.php">Reklama</a></li>
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Reklama</h1>
                <p class="mb-0">Zainteresowany współpracą?<br>Zareklamuj się u nas!</p>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5"  data-aos="fade" data-aos-delay="100">
            ...
            <div class="p-4 mb-3 bg-white">
              <p class="mb-0 font-weight-bold">Zainteresowany współpracą?</p>
              <p class="mb-4"><br>Zareklamuj się u nas!
              Jesteś zainteresowany zareklamowaniem się u nas?
              Nic trudnego!<br> Reklama w wyznaczonych do tego miejscach, na stronie głównej, podstronach lub na tle strony.
              Wszelkie pytania dotyczące reklamy prosimy kierować na elektroniczny adres: <a href="#">reklama@bezgrosika.pl</a><br>
