...
<html lang="pl">
  <head>
	<title>Pozostałe - Ogłoszenia BezGrosika.PL</title>
	<meta name="description" content="Pozostałe, ogłoszenia pozostałe, nie pasujące do innych kategorii w serwisie ogłoszeniowym BezGrosika.pl"/>
	<meta name="keywords" content="ogłoszenia, BezGrosika, .pl, sprzedam, kupie, pozostałe"/>
  ...
  <div class="site-wrap">
	...
	<div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row mt-5">
		  ...
		  <div class="col-lg-6">
            <div class="d-block d-md-flex listing">
              <a href="#" class="img d-block" style="background-image: url('../images/img_9.jpg')"></a>
              <div class="lh-content">
                <span class="category" style="background-color: #f89d13;">Pozostałe</span>
				<a href="#" class="bookmark"><span class="icon-star text-warning" style="font-size: 25px;"></span></a></a>
                <h3><a href="#">Sprzedam deski</a></h3>
                <address style="display: inline-block;"><span style="display: inline-block;" class="icon-tags"></span> 50 PLN</address>
              </div>
            </div>
		  </div>
		...
		<?php
							$zapytanie = 'SELECT * FROM pozostale_pozostale WHERE datepromotion > NOW()';
							$zapytanie1 = 'SELECT * FROM pozostale_pozostale WHERE datepromotion < NOW()';
							...
							try {
								...
								if(!$connect->set_charset("utf8")){
									...
									if($result = $connect->query('SELECT * FROM pozostale_pozostale')){
										...
										if($wyniki>0){
											for($r = 1; $r <= $wyniki; $r++){
												...
												if($w['dateremove'] <= $date){
													...
													@$connect->query('DELETE FROM pozostale_pozostale WHERE ID='.$w['ID'].'');
												}
											}
										}
										$result->free_result();
		...
		// --------------------------------------------- WYŚWIETLENIE WYNIKÓW ------------------------------------------------------------------
						...
						try{
							...
							if (!$connect->set_charset("utf8")) {
								...
								$pytanie = 'SELECT * FROM pozostale_pozostale';
