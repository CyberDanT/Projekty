...
<?php
	$_SESSION['info_ogl'] = 'pozostale';
	$_SESSION['info_ogl2'] = 'pozostale';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."pozostale";
	$zapytanie = 'SELECT * FROM pozostale_pozostale WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="pozostale_pozostale">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Pozostałe <span style="font-size: 10px;">●</span> Pozostałe ogłoszenia</div><br>';
									echo '</div>';
