...
$_SESSION['info_ogl2'] = 'pojazdy rolnicze';
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<meta name="keywords" content="motoryzacja, pojazdy, rolnicze, ciągniki i traktory, sprzedam traktor, przyczepę, sprzedam"/>
	</head>
...
<?php
	...
	$db_name = "motoryzacja";
	$zapytanie = 'SELECT * FROM pojazdy_rolnicze WHERE ID="'.$ID.'"';
							...
							echo '<div style="height: 45px; font-size: 25px; color: #CCC; text-shadow: 1px 1px black;">
										...
										<div class="zna">
											<form method="post" target = "_blank" action="../zglosnaduzycie.php">
												<input type="hidden" name="category" value="pojazdy_rolnicze">
								...
								echo '<div class="oglci"><b>Kategoria:</b></div> <div class="oglci1">Motoryzacja ● Pojazdy rolnicze</div><br>';
