...
<?php
	$_SESSION['info_ogl'] = 'oddam za darmo';
	$_SESSION['info_ogl2'] = 'oddamzadarmo';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."oddamzadarmo";
	$zapytanie = 'SELECT * FROM oddamzadarmo WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="oddamzadarmo">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Oddam za darmo</div><br>';
									echo '</div>';
