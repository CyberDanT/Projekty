...
<?php
	...
	$_SESSION['info_ogl2'] = 'dodatki';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."odziez";
	$zapytanie = 'SELECT * FROM odziez_dodatki WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="odziez_dodatki">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Odzież <span style="font-size: 10px;">●</span> Dodatki</div><br>';
									echo '</div>';
