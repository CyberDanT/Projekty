...
<?php
	...
	$_SESSION['info_ogl2'] = 'buty';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."odziez";
	$zapytanie = 'SELECT * FROM odziez_buty WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="odziez_buty">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Odzież <span style="font-size: 10px;">●</span> Buty</div><br>';
									echo '</div>';
