...
<html lang="pl">
  <head>
	<title>Odzież - pozostałe - ogłoszenia BezGrosika.pl</title>
	<meta name="description" content="Odzież, ubrania, suknie ślubne, zegarki, dodatki, obuwie i inne."/>
	<meta name="keywords" content="ogłoszenia, BezGrosika, .pl, sprzedam, kupie, odzież, pozostałe"/>
  ...
  <div class="site-wrap">
	...
	<div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row mt-5">
		  ...
		  <div class="col-lg-6">
            <div class="d-block d-md-flex listing">
              <a href="#" class="img d-block" style="background-image: url('../images/img_6.jpg')"></a>
              <div class="lh-content">
                <span class="category" style="background-color: #f89d13;">Odzież</span>
				<a href="#" class="bookmark"><span class="icon-star text-warning" style="font-size: 25px;"></span></a></a>
                <h3><a href="#">Sprzedam suknie</a></h3>
                <address style="display: inline-block;"><span style="display: inline-block;" class="icon-tags"></span> 1 500 PLN</address>
              </div>
            </div>
		  </div>
		...
		<!-- Ogłoszenia zwykłe -->
          <div class="col-lg-6">
            <div class="d-block d-md-flex listing">
              <a href="#" class="img d-block" style="background-image: url('../images/img_6.jpg')"></a>
              <div class="lh-content">
                <span class="category">Odzież</span>
                <h3><a href="#">Sprzedam suknie</a></h3>
                <address style="display: inline-block;"><span style="display: inline-block;" class="icon-tags"></span> 1 500 PLN</address>
              </div>
            </div>
		...
		<?php
							$zapytanie = 'SELECT * FROM odziez_pozostale WHERE datepromotion > NOW()';
							$zapytanie1 = 'SELECT * FROM odziez_pozostale WHERE datepromotion < NOW()';
							...
							try {
								...
								if(!$connect->set_charset("utf8")){
									...
									if($result = $connect->query('SELECT * FROM odziez_pozostale')){
										...
										if($wyniki>0){
											for($r = 1; $r <= $wyniki; $r++){
												...
												if($w['dateremove'] <= $date){
													...
													@$connect->query('DELETE FROM odziez_pozostale WHERE ID='.$w['ID'].'');
												}
											}
										}
										$result->free_result();
		...
		// --------------------------------------------- WYŚWIETLENIE WYNIKÓW ------------------------------------------------------------------
						...
						try{
							...
							if (!$connect->set_charset("utf8")) {
								...
								$pytanie = 'SELECT * FROM odziez_pozostale';
