...
<html lang="pl">
  <head>
    <title>Wyniki wyszukiwania - BezGrosika.pl</title>
    <meta name="keywords" content="serwis ogłoszeniowy Bez Grosika, samochody osobowe audi bez grosika"/>
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                ...
                <p class="mb-0">Znalazłeś to czego szukasz?</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Wyniki wyszukiwania</h2>
          </div>
        </div>
        <div class="row mt-5">
									...
									if($wyniki>0){
										...
										echo '<div style="font-size: 20px; text-shadow: 1px 1px black; color: #CCC;">';
											if(isset($_SESSION['user']) && $_SESSION['user'] == $_GET['user']){
												...
												echo 'Nie znaleziono ogłoszeń pasujących do kryterii wyszukiwania.';
											}
										echo '</div>';
									}
								...
								if($result = @$connect->query($pytanie)){
									...
									<div class="col-12 mt-5 text-center">
									  <div class="custom-pagination">';
										...
										if($showpage != 1){
											echo '<a href="search.php?page='.$previouspage.'">'.$seepreviouspage.'</a>';
										}else{
											echo '<a href="#">_</a>';
										}
										...
										if($lStron == $showpage){
											...
											echo '<a href="search.php?page='.$nextpage.'">'.$seepage.'</a>';
										}
