...
<html lang="pl">
  <head>
    <title>Wszystko w motoryzacja - BezGrosika.pl serwis ogłoszeniowy</title>
	...
	<meta name="description" content="Wszystko w kategorii motoryzacja, samochody osobowe, samochody ciężarowe, samochody dostawcze, rolnicze, pozostałe, radio, części do samochodu i inne w ogłoszeniach BezGrosika.pl"/>
    <meta charset="utf-8">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Motoryzacja</h1>
                <p class="mb-0">Wszystkie ogłoszenia w motoryzacji</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Wszystkie w motoryzacja</h2>
          </div>
        </div>
        <div class="row mt-5">
					...
					try{					
						...
						if(!$connect->set_charset("utf8")){
							...
							if($result = $connect->query($pytanietymczasowa)){
								...
								$pytanko1 = 'SELECT * FROM samochody_osobowe';
								...
								$connect->select_db($administratorbazy.'motoryzacja');
								$pytanko1 = 'SELECT * FROM samochody_ciezarowe';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'motoryzacja');
								$pytanko1 = 'SELECT * FROM samochody_dostawcze';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'motoryzacja');
								$pytanko1 = 'SELECT * FROM motocykle_skutery';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'motoryzacja');
								$pytanko1 = 'SELECT * FROM pojazdy_rolnicze';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'motoryzacja');
								$pytanko1 = 'SELECT * FROM felgi_opony';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'motoryzacja');
								$pytanko1 = 'SELECT * FROM pozostale';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								if($result = @$connect->query($pytanie)){
									...
									<div class="col-12 mt-5 text-center">
									  <div class="custom-pagination">';
										if($lStron != 0){
											if($showpage != 1){
												echo '<a href="motoryzacja.php?page='.$previouspage.'">'.$seepreviouspage.'</a>';
											}else{
												echo '<a href="#">_</a>';
											}
											...
											if($lStron == $showpage){
												...
												echo '<a href="motoryzacja.php?page='.$nextpage.'">'.$seepage.'</a>';
											}
