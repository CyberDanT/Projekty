...
<html lang="pl">
  <head>
	...
	<title>Wszystko w dom i ogród - BezGrosika.pl serwis ogłoszeniowy</title>
	<meta name="keywords" content="serwis ogłoszeniowy, meble ogrodowe, meble kuchenne, akcesoria do kuchni, noże, garnki, dla domu i ogrodu, łazienka, szafy, bezgrosika"/>
	<meta name="description" content="Wszystko w kategorii dla domu i ogrodu. Meble kuchenne, szafy, meble ogrodowe, akcesoria do kuchni, stół i kszesła, meble do łazienki, meble do pokoju, szafki i inne w ogłoszeniach BezGrosika.pl"/>
	<meta charset="utf-8">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Dom i ogród</h1>
                <p class="mb-0">Wszystkie ogłoszenia w domie i ogrodzie</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Wszystkie w domu i ogrodzie</h2>
          </div>
        </div>
        <div class="row mt-5">
					...
					try{					
						...
						if(!$connect->set_charset("utf8")){
							...
							if($result = $connect->query($pytanietymczasowa)){
								...
								$pytanko1 = 'SELECT * FROM domogrod_meble';
								...
								$connect->select_db($administratorbazy.'domiogrod');
								$pytanko1 = 'SELECT * FROM domogrod_ogrod';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'domiogrod');
								$pytanko1 = 'SELECT * FROM domogrod_oswietlenie';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'domiogrod');
								$pytanko1 = 'SELECT * FROM domogrod_pozostale';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								$connect->select_db($administratorbazy.'domiogrod');
								$pytanko1 = 'SELECT * FROM domogrod_rtvagd';
								if($result = $connect->query($pytanko1)){
									//echo 'wybrano samochody_osobowe';
									$wyniki = $result->num_rows;
									if($wyniki>0){
								...
								if($result = @$connect->query($pytanie)){
									...
									<div class="col-12 mt-5 text-center">
									  <div class="custom-pagination">';
										if($lStron != 0){
											if($showpage != 1){
												echo '<a href="domiogrod.php?page='.$previouspage.'">'.$seepreviouspage.'</a>';
											}else{
												echo '<a href="#">_</a>';
											}
											...
											if($lStron == $showpage){
												...
												echo '<a href="domiogrod.php?page='.$nextpage.'">'.$seepage.'</a>';
											}
