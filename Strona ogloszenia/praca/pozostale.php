...
<html lang="pl">
  <head>
	<title>Praca pozostałe - Ogłoszenia BezGrosika.pl</title>
	<meta name="description" content="Praca, dorywcza, w kraju, za granicą, opieka nad dzieckiem, usługi i inne..."/>
	<meta name="keywords" content="ogłoszenia, BezGrosika, .pl, sprzedam, praca, pozostałe"/>
  ...
  <div class="site-wrap">
	...
	<div class="site-section bg-light">
      <div class="container">
		  ...
		  <div class="col-lg-6">
            <div class="d-block d-md-flex listing">
              ...
              <div class="lh-content">
                ...
                <h3><a href="#">Opieka nad dzieckiem</a></h3>
		...
		<?php
							$zapytanie = 'SELECT * FROM praca_pozostale WHERE datepromotion > NOW()';
							$zapytanie1 = 'SELECT * FROM praca_pozostale WHERE datepromotion < NOW()';
							...
							try {
								...
								if(!$connect->set_charset("utf8")){
									...
									if($result = $connect->query('SELECT * FROM praca_pozostale')){
										...
										if($wyniki>0){
											for($r = 1; $r <= $wyniki; $r++){
												...
												if($w['dateremove'] <= $date){
													...
													@$connect->query('DELETE FROM praca_pozostale WHERE ID='.$w['ID'].'');
												}
											}
										}
										$result->free_result();
		...
		// --------------------------------------------- WYŚWIETLENIE WYNIKÓW ------------------------------------------------------------------
						...
						try{
							...
							if (!$connect->set_charset("utf8")) {
								...
								$pytanie = 'SELECT * FROM praca_pozostale';
