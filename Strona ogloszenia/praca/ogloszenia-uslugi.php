...
<?php
	...
	$_SESSION['info_ogl2'] = 'uslugi';
	require_once("../php/connect.php");
	$db_name = $administratorbazy."praca";
	$zapytanie = 'SELECT * FROM praca_uslugi WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="praca_uslugi">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Praca <span style="font-size: 10px;">●</span> Usługi</div><br>';
									echo '</div>';
