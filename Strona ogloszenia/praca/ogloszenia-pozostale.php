...
<?php
	...
	$zapytanie = 'SELECT * FROM praca_pozostale WHERE ID="'.$ID.'"';
							  ...
							  <div class="container">
								<div class="row">
								  <div class="col-lg-8">
										...
										<center>
											<div class="ogl-icons-div">
												<form method="post" target = "_blank" action="../promotion.php">
													<input type="hidden" name="category" value="praca_pozostale">
									...
									echo '<div>';
									echo '<div><b>Kategoria</b></div> <div>Praca <span style="font-size: 10px;">●</span> Pozostałe</div><br>';
									echo '</div>';
